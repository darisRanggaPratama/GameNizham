...
class Tank(pg.sprite.Sprite):
    ...
    def shoot(self):
        # Sesuaikan posisi peluru berdasarkan arah tank
        if self.direction == 1:  # Tank menghadap kanan
            bullet_x = self.rect.right  # Mulai dari sisi kanan tank
        else:  # Tank menghadap kiri
            bullet_x = self.rect.left  # Mulai dari sisi kiri tank
