...
class Display:
    ...
    background_music = pygame.mixer.Sound("background.mp3")  # Add background music
    ...
    def controls(self, event):
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_w:
                ...
                if not self.object.background_music_playing:
                    Display.background_music.play(-1)  # Loop background music
                    self.object.background_music_playing = True
