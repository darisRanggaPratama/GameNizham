...
backgrounds = [
    ...
    pygame.transform.scale(pygame.image.load("background1.jpg"), (widthScreen, heightScreen)),
    pygame.transform.scale(pygame.image.load("background2.jpg"), (widthScreen, heightScreen)),
    pygame.transform.scale(pygame.image.load("background3.jpg"), (widthScreen, heightScreen)),
...
background_music = pygame.mixer.Sound("background3.mp3")
